...
func TestCreateRuntimeStep_Run(t *testing.T) {
	...
	step := NewCreateRuntimeStep(memoryStorage.Operations(), memoryStorage.RuntimeStates(), memoryStorage.Instances(), provisionerClient, logrus.New())
...
func TestCreateRuntimeStep_RunWithBadRequestError(t *testing.T) {
	...
	step := NewCreateRuntimeStep(memoryStorage.Operations(), memoryStorage.RuntimeStates(), memoryStorage.Instances(), provisionerClient, log)
